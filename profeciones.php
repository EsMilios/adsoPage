...
<div class="min-h-screen bg-gray-100 p-8">
    ...
    <div class="text-center mb-12">
        <h1 class="text-5xl font-bold text-gray-800">
            IT Professions in Software Analysis and Development
        </h1>
        <p class="text-lg text-gray-600 mt-4">
            Discover key roles, their requirements, responsibilities, and career opportunities in the IT industry.
        </p>
    </div>

    <!-- Contenedor de las profesiones -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700">
                    <strong>Technical Requirements:</strong> Proficiency in Python, Java, or C++; experience with version control tools like Git.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Designing, coding, and debugging applications; maintaining and improving software.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> Application Developer, Full-Stack Developer.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Analyzing data, generating insights, and creating visual reports.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> Business Intelligence Analyst, Data Scientist.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Planning, executing, and leading IT projects to meet objectives.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> Scrum Master, Program Manager.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Creating intuitive and aesthetically pleasing user interfaces.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> User Experience Designer, Interaction Designer.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Protecting systems from cyber threats and responding to security breaches.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> Security Analyst, Penetration Tester.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2">
                    <strong>Responsibilities:</strong> Automating and streamlining software deployment processes.
                </p>
                <p class="text-gray-700 mt-2">
                    <strong>Occupations:</strong> Site Reliability Engineer, Cloud Engineer.
                </p>
            </div>
        </div>
    </div>
